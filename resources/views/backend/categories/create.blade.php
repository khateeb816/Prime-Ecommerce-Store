            ...
            <div class="white-box p-4 bg-white rounded shadow-sm">
                <form method="POST" action="{{ route('backend.categories.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="hidden" name="icon" id="selected_icon" value="bi-grid">
                        <div class="icon-picker-container border rounded p-3 bg-light" style="max-height: 250px; overflow-y: auto;">
                            <div class="row g-2" id="icon_grid">
                                ...
                                @foreach($icons as $icon)
                                    <div class="col-auto">
                                        <div class="icon-item p-2 border rounded bg-white text-center cursor-pointer {{ $icon == 'bi-grid' ? 'border-primary bg-primary-light' : '' }}" 
